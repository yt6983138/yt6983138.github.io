...
namespace yt6983138.github.io.RksReaderEnchanced;
public static class PhiDecrypt // generated by ai
{
    ...
    public static string DecryptNew(string base64EncryptedString)
    {
        byte[] state = initialVector.QuickCopy(); // readonly != immutable
    ...
    {
        byte[] tempState = state.QuickCopy();
        for (byte i = 0; i < 16; i++)
        {
    ...
    private static T[] QuickCopy<T>(this T[] array)
    {
